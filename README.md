...
### ![](svgs/chart-bar.svg =20x20) Multi-API Geolocation
...
### ![](svgs/lightning.svg =20x20) Advanced Speedtest
...
### ![](svgs/search.svg =20x20) Integrated Whois / RDAP
...
### ![](svgs/wrench.svg =20x20) Network Tools
...
### ![](svgs/clipboard.svg =20x20) Copy All / Export JSON
...
### ![](svgs/info.svg =20x20) System Tray
...
1. **Overview** ![](svgs/chart-bar.svg =16x16): View your current public IP, location data, ISP, ASN, and security information.
...
2. **Whois Lookup** ![](svgs/search.svg =16x16): Perform Whois/RDAP lookups for any IP address.
   - Choose from RDAP (Standard), IP-API (Detailed), or IP-Whois.io.
   - Results are normalized and displayed in a clean, sortable table.

3. **Network Tools** ![](svgs/wrench.svg =16x16):
...
4. **History** ![](svgs/scroll.svg =16x16): View all IP changes recorded during your session with accurate timestamps. Clear with one click.

5. **Speedtest** ![](svgs/lightning.svg =16x16): Run internet speed tests using `speedtest-cli`.
...
6. **About** ![](svgs/info.svg =16x16): View build information including compiler name/version, C++ standard, system architecture, Qt version, and compile date/time.
...
### ![](svgs/chart-bar.svg =18x18) Geo-IP Geolocation (IPv4)
...
### ![](svgs/chart-bar.svg =18x18) Geo-IP Geolocation (IPv6)
...
### ![](svgs/search.svg =18x18) Whois / RDAP Lookup
...
### ![](svgs/info.svg =18x18) Country Flags
